...
def split_video_by_frames(input_video_path, frames_per_segment, output_path):
    """
...
def process_videos_in_folder(input_folder, frames_per_segment, output_folder):
    """
    ...
    for video_file in tqdm(video_files, desc="Processing videos"):
        ...
        split_video_by_frames(input_video_path, frames_per_segment, output_folder)
...
def main():
    ...
    if os.path.isfile(args.input_path):
        # 处理单个视频
        split_video_by_frames(args.input_path, args.frames_per_segment, args.output_path)
    else:
        # 处理文件夹中的所有视频
        process_videos_in_folder(args.input_path, args.frames_per_segment, args.output_path)
